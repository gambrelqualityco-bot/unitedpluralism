...
const COMMITMENTS = [
  { icon: Scale, title: "Equity", text: "Equal dignity and rights for every person — and the correction of barriers that keep people from both." },
...
const CHAPTERS = [
  ...
  },
  {
    ...
    body: [
      ...
      "We defend the freedom of others to seek meaning differently from us, including the freedom to live without religion — and we remain mindful that we may be wrong, and willing to grow when greater understanding requires it.",
    ],
  },
];
...
const About = () => (
  <div data-testid="about-page">
    ...
    <section className="relative bg-navy-950 grain overflow-hidden">
      <div className="absolute -top-32 right-0 h-96 w-96 rounded-full bg-gold/10 blur-3xl pointer-events-none" />
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-20 lg:pt-44 lg:pb-28">
        ...
        <Reveal delay={0.55}>
          <p className="mt-7 max-w-2xl text-base sm:text-lg leading-relaxed text-slate-300">
            ...
            worldviews come together around shared values and responsibilities — for community, ethical guidance,
    ...
    <section className="py-20 lg:py-32" data-testid="covenant-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20 lg:space-y-28">
        {CHAPTERS.slice(0, 2).map((ch, i) => (
          <Reveal key={ch.num}>
            <div className={`grid lg:grid-cols-12 gap-8 lg:gap-14 items-start ${i % 2 ? "" : ""}`}>
    ...
    <section className="relative overflow-hidden" data-testid="vision-section">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
        <Reveal>
          ...
          <p className="mt-7 max-w-2xl text-base leading-relaxed text-slate-300">
