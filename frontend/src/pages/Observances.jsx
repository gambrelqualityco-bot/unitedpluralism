...
const EVENTS = [
  ...
  { name: "Winter Solstice Gathering", date: "Dec 21", pillar: "Seasonal Gatherings", desc: "The longest night, held within Charisel with candles, music, and shared warmth." },
          ...
          <div className="lg:col-span-6">
            <Reveal>
              <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.22em] text-gold-light">
                <Moon className="h-4 w-4" /> October 1 to November 2
              </p>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <Reveal>
              <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.22em] text-gold">
                <Sunrise className="h-4 w-4" /> December 1 to January 1
              </p>
